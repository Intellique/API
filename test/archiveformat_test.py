...
class ArchiveformatTest(CommonTest):
    ...
    def test_02_get_list_archive_wrong_offset(self):
        conn, headers, message = self.newLoggedConnection('admin')
    ...
    def test_06_get_list_archive_wrong_limit_negative(self):
        conn, headers, message = self.newLoggedConnection('admin')
    ...
    def test_07_get_list_archive_wrong_order_by(self):
        conn, headers, message = self.newLoggedConnection('admin')
    ...
    def test_08_get_list_archive_wrong_order_asc(self):
        conn, headers, message = self.newLoggedConnection('admin')
    ...
    def test_09_get_list_archive_wrong_limit_string(self):
        conn, headers, message = self.newLoggedConnection('admin')
    ...
    def test_10_get_list_archive_wrong_limit_zero(self):
        conn, headers, message = self.newLoggedConnection('admin')
